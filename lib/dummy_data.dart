...
const DUMMY_APARTMENT = const [
  ...
  Apartment(
    ...
    desc: 'It’s a 3 bhk apartment situated in Runwal Forests, Kanjurmarg West ,Mumbai. It has a wide area. The property is available at a monthly rental of Rs. 10,000 . The house is furnished. This residential property is ready-to-move-in. It is situated in the proximity of all the important facilities. Contact us for more details.',
    features: ['Wi-Fi', 'Bed', 'Table', 'Shelf'],
    images: 'https://www.thenationalnews.com/image/policy:1.140204:1499281895/image/jpeg.jpg?\$p=79ddad7&w=1136&\$w=ec52ab9',
    is1BHK: false,
    is2BHK: false,
    is3BHK: true,
    isfurnished: false,
  ...
  Apartment(
    ...
    images: 'https://5.imimg.com/data5/LS/JG/JD/SELLER-9871519/bed-room-furniture-500x500.jpg',
    is1BHK: true,
    is2BHK: false,
    is3BHK: false,
    isfurnished: true,
...
// Delhi
  ...
  Apartment(
    ...
    features: ['Wi-Fi', 'Bed', 'Table', 'Shelf'],
    images: 'https://media-cdn.tripadvisor.com/media/vr-splice-j/09/e3/30/c5.jpg',
    is1BHK: false,
    is2BHK: false,
    is3BHK: true,
    isfurnished: false,
